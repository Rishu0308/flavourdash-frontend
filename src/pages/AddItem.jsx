...
function AddItem() {
  ...
  const categories = [
    "Snacks", "Main Course", "Desserts", "Pizza",
    "Burgers", "Sandwiches", "South Indian", "North Indian",
    "Chinese", "Fast Food", "Other"
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    if (!backendImage) {
      toast.error("⚠️ Please upload a food image!", { position: "bottom-right" });
      return;
    }
