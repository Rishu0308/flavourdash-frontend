    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style=
            ...
            [1px] `} style={{
                ...
                <h1 className={`text-3xl font-bold mb-2`} style={{ color: primaryColor }}>FLAVOR DASH</h1>
                <p className='text-gray-600 mb-8'>Sign In account to get started with delicous food delivers</p>
                {/* email */}
                ...
                rounded-lg px-4 py-2 transtion duration-200 border-gray-400 hover:bg-gray-100'
