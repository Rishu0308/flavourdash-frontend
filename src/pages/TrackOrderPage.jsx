...
function TrackOrderPage() {
    ...
    return (
        <div className='max-w-4xl mx-auto p-4 flex flex-col gap-6 min-h-screen'>
            {/* Header Section */}
            <div
                className='relative flex items-center gap-4 top-[20px] left-[20px] z-[10px] cursor-pointer'
            ...
            {/* Footer Section */}
            <footer className='text-center mt-10 py-4 border-t border-gray-200 text-sm text-gray-600'>
                ✨ MADE BY <span className='font-bold text-[#ff4d2d]'>RISHU KUMAR 🚀</span>
            </footer>
        </div>
    )
}
